...
async def main():
    ...
    async with AsyncWebsocketClient("wss://s.devnet.rippletest.net:51233") as client:
        ...
        impair_response = await submit_and_wait(loan_manage_impair, client, loan_broker)
        ...
        default_response = await submit_and_wait(loan_manage_default, client, loan_broker)
