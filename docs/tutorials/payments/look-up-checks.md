...
{% code-snippet file="/_code-samples/checks/js/get-checks.js" language="js" from="// Loop through account objects" before="// Filter results" /%}
...
{% code-snippet file="/_code-samples/checks/js/get-checks.js" language="js" from="// Filter results" before="// Disconnect" /%}
